...
class Satlike {
 private:
  ...
  void myinit(vector<int>& init_solution);
  void flip(int flipvar);
  void myflip(int flipvar);
  void update_goodvarstack1(int flipvar);
  void my_update_goodvarstack1(int flipvar);
 ...
 public:
  Satlike();
  void build_instance_from_maxhs(Wcnf* formula);
  void local_search(vector<int>& init_solution);
  void local_search_for_bmo(vector<int>& init_solution, int* solver_stage);
  void local_search_for_me(vector<int>& init_solution, int* solver_stage);
  int* continue_from_init_solution(vector<int> init_solution, Wcnf* formula, int* solver_stage);
  void simple_print();
